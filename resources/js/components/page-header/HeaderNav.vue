<template>
    <nav class="projectnav clearfix">
        <ul class="projectnav_controls clearfix">
            ...
            <li id="header-nav-current-btn" :class="currentClass">
                <a :href="current">CURRENT</a>
            </li>
            <li id="header-nav-next-btn" :class="nextClass">
                <a :href="next">
                    NEXT
                    <svg id="i-chevron-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="8" height="8" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="4">
...
<script>
    ...
    export default {
        ...
        computed: {
            previousClass () {
                return typeof this.previous === 'undefined' ? 'btn-disabled' : 'btn';
            },

            currentClass () {
                return typeof this.current === 'undefined' ? 'btn-disabled' : 'btn';
            },
